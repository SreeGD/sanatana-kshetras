---
id: kollur-mookambika-temple-kollur
name: "Kollur Mookambika Temple"
deities:
  - "Mookambika (Parvati/Saraswati/Lakshmi combined)"
traditions: [shakta]
continent: asia
country: "India"
region: "Karnataka"
city: "Kollur"
coordinates: {lat: 13.855, lng: 74.85}
...
best_time_to_visit: "October to March; Navaratri is the major festival season."
how_to_reach: "Nearest railway station Kundapura (~35 km); nearest airport Mangalore (~135 km); reachable by road through the Western Ghats."
associated_saints:
  - "Adi Shankaracharya"
festivals:
...
status: verified
review_flags:
  - "The entry deliberately omits the ~800 CE founding date and King Halugallu Veera Sangayya from the body text since that specific claim could not be independently corroborated beyond a single encyclopedia mention; only the shrine's physical description and its traditional (legend-labeled) narrative are stated as such."
---
