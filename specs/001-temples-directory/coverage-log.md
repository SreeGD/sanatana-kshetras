...
## Regional Shaiva circuits, Paadal Petra Sthalam sample, missed countries, and USA expansion

A broader, six-agent parallel round covering several independent threads at once. 62 new temples added net of one duplicate cleanup, bringing the total to 602.

**Small regional circuits (17)**: Pancharama Kshetras (4 of 5 missing — Amararama/Amaravathi, Somarama/Bhimavaram, Ksheerarama/Palakollu, Kumararama/Samalkota; Draksharamam already covered) and the third Trilinga Kshetra (Kaleshwaram, Telangana — the weakest-documented of the group, no founding date found in any source, honestly flagged as such). Nava Kailasam (9/9 — a distinct Shiva-temple group along the Thamirabarani river, Tirunelveli/Thoothukudi districts, explicitly NOT the same as the already-covered Kumbakonam-area Navagraha circuit; several entries carry only bare group-membership sourcing and are honestly marked `pending`/legend rather than padded with invented detail). Pancha Sabhai (3 of 5 missing — Thiruvalangadu/Ratna Sabha, Tirunelveli/Tamra Sabha, Courtallam/Chitra Sabha; Chidambaram and Madurai already covered).

**Paadal Petra Sthalam sample (21)**: Given the full canonical list runs to ~276 temples (more than double the entire Divya Desam collection) with thin English sourcing for most village-level entries, a scale-assessment pass recommended a curated subset of the most historically/architecturally significant sites rather than a full push. The writing agent added 21 well-documented temples (Thyagaraja/Tiruvarur, Aiyarappar/Thiruvaiyaru, Adi Kumbeswarar/Kumbakonam, and others spanning Chola Nadu, Tondai Nadu, Kongu Nadu, and Nadu Nadu) and, notably, independently verified and *rejected* several sites this project had suggested as candidates (Gangaikonda Cholapuram, Airavatesvara Temple/Darasuram, Kailasanathar Temple/Kanchipuram) after confirming via Wikipedia that they either postdate the closing of the Tevaram canon or are explicitly not classified as Paadal Petra Sthalams. Coverage now sits at roughly 36/276 (~13%); the remaining ~240 are a deliberate, documented exclusion given the sourcing bar, not an oversight.

**Missed countries (6)**: A fresh scan (prompted by noticing Russia had been omitted from the original continent-by-continent sweep) found and added Russia (ISKCON Moscow, `pending` — a widely-referenced demolition/relocation controversy could not be independently confirmed via Wikipedia, so only the confirmed 1991 founding is asserted), Bahrain (Shrinathji Temple, Manama, 1817 — one of the oldest in the Middle East), Oman (Motishwar Mandir, Muscat), Afghanistan (Asamai Temple, Kabul — handled with explicit sensitivity given the country's severely diminished Hindu population, current operating status left unconfirmed rather than assumed), Bhutan (Hindu Dharma Samudaya Temple, Thimphu), and Japan (ISKCON New Gaya, Tokyo). Qatar and Kuwait were checked and correctly skipped — large Hindu populations but no specific, independently documented temple found.

**USA expansion (21)**: The existing USA coverage (12 entries) was recognized as thin relative to the size of the Hindu American population and audited in two parallel regional passes. Northeast/Midwest additions include the historically significant Hindu Temple Society of North America (Flushing, Queens, NY — mid-1970s, one of the oldest traditional Hindu temples in the US) and Sri Venkateswara Temple, Bridgewater, NJ (explicitly distinguished from the already-covered, separate Pittsburgh Sri Venkateswara Temple). West/South additions include BAPS Chino Hills, CA (the world's first earthquake-proof stone mandir, with a genuine timeline inconsistency in its own sourcing flagged rather than smoothed over) and Karya Siddhi Hanuman Temple, Frisco, TX (a Guinness World Record holder for continuous Hanuman Chalisa chanting). One documented controversy (Radha Madhav Dham/Barsana Dham's founder's 2011 conviction) was disclosed factually without editorializing, consistent with how an existing BAPS Houston entry's labor lawsuit was already handled. The Livermore Shiva-Vishnu Temple — flagged as the top-priority candidate — was honestly left out after its official site proved unrenderable via WebFetch and no dedicated Wikipedia article could be found; not forced.

**Cross-cutting audit**: With six agents running in parallel across overlapping geographic areas (three separate agents touching Tamil Nadu alone), a full repository-wide audit was run afterward: schema validation, duplicate detection, `id`-field collision check (not just filename collision), Divya Desam completeness, and a coverage report. This surfaced one genuine, pre-existing duplicate predating this session's continuation: `mata-basanti-devi-mandir` aside, the *Mansa Devi Temple, Bilaspur* (Panchkula district, Haryana) had been independently filed twice in an earlier state-by-state audit round — once correctly under `haryana/`, and once redundantly under `chandigarh/` (whose own review_flags admitted the temple isn't actually within Chandigarh UT boundaries). The Chandigarh copy was removed as redundant now that the real Chandigarh-UT gap is separately and correctly filled by Mata Basanti Devi Mandir, Sector 24. No other id or filename collisions were found across the full 602-temple repository.

602 temples total (53 countries outside India, up from 47), all schema-valid; the sole remaining duplicate-detector flag (Chandi Devi/Mansa Devi, Haridwar) is the previously investigated false positive.

## Category-aware re-audit of all 33 India states/UTs

The original state-by-state audit looked for "major spiritual destinations" broadly; this round re-checked every state against a fuller checklist built up from the category-specific passes since then (mountain/hill shrines, river confluences/sources, rare-deity temples, major-city civic landmarks, regional circuits). Five parallel regional agents (North, East, West, South India, and the Union Territories) added 65 new temples, bringing the total to 667.

**Significant finds that had been completely or largely missing despite how comprehensive this repo already was**: Ram Janmabhoomi Mandir, Ayodhya (consecrated Jan 2024 — the existing Ayodhya entry was a different, classical Divya Desam temple entirely); Krishna Janmasthan Temple Complex, Mathura (previously only mentioned in passing inside another file); Jageshwar Dham (a ~125-temple ancient Shaiva complex, Uttarakhand); the entire Varkari pilgrimage circuit's feeder sites — Alandi (Sant Dnyaneshwar's samadhi) and Dehu (Sant Tukaram's birthplace/samadhi) — despite Pandharpur itself already being covered; Unakoti, Tripura (major 7th-9th century rock-cut hillside carvings, UNESCO tentative list 2022, missing despite Tripura already having 2 other entries); and the Hoysala UNESCO pair Chennakeshava Temple/Belur and Hoysaleswara Temple/Halebidu (Karnataka).

**Kerala** was confirmed as the most under-covered major state (15→22 entries), yielding Mannarasala Sree Nagaraja Temple (a serpent-grove/Kavu tradition site — a genuine rare-deity gap), Thirunelli Temple ("Kashi of the South"), Vaikom Sree Mahadeva Temple, Attukal Bhagavathy Temple, Sree Poornathrayeesa Temple, Kottiyoor Temple ("Kerala's Amarnath," open only ~27 days a year), and Aluva Mahadeva Temple (filling the Periyar riverbank gap).

**State-capital and civic-landmark gaps** were a recurring theme: Lucknow, Jaipur (Birla Mandir), Ranchi (Pahari Mandir), Raipur (Dudhadhari Temple), Gangtok (Hanuman Tok), and Ahmedabad (the original 1822 Swaminarayan Mandir, Kalupur) all had zero or thin representation in their state capitals before this pass despite the states themselves being otherwise covered.

**Honest negatives**: Punjab (Sikh-majority demographics, no further Jyotirlinga/Shakti-Peetha-caliber site beyond what's covered), Ladakh (a real Hindu minority in Leh, but no specific documented temple clears the sourcing bar), Lakshadweep (96.6% Muslim, no Hindu temple presence documented anywhere), and the Northeast hill states (Meghalaya, Nagaland, Arunachal Pradesh, Mizoram, and largely Manipur) — all re-confirmed via a second, independent check as genuinely thin rather than under-researched.

**Process note**: the South India regional agent's own internal sub-agents disregarded "research only, do not write" instructions and wrote files directly while running concurrently on overlapping states, causing real file races — three Karnataka entries were deleted mid-run by a race and had to be rewritten from already-verified content. The end state was independently re-verified after all agents completed (full schema validation, duplicate detection, and a repo-wide `id`-field collision check, not just the affected files) and confirmed clean, but this is a caution against nesting research-only sub-delegation inside a category-audit agent without stronger isolation.

667 temples total, all schema-valid, 108/108 Divya Desam intact, zero `id` or filename collisions anywhere in the repository; the sole duplicate-detector flag remains the previously investigated Chandi Devi/Mansa Devi (Haridwar) false positive.

## Category-aware re-audit of all countries outside India, plus a dedicated USA ISKCON pass

Extended the fuller-checklist re-audit methodology (mountain shrines, rare-deity temples, major-city civic landmarks, ISKCON coverage) to every country outside India, mirroring the India re-audit. Six parallel regional agents (South Asia, Southeast/East Asia + Middle East, Europe, Africa, Americas excluding USA, Oceania) plus a seventh dedicated to USA ISKCON coverage added 162 new temples, bringing the total to 825.

**Largest single-country gaps found**: Indonesia (6→15) — genuinely new territory beyond Bali, including Java's Majapahit-era Hindu mountain temples (Candi Sukuh, Candi Cetho) and several major Bali sites (Tirta Empul, Pura Goa Lawah, Gunung Kawi); Japan (1→6) — five of Japan's six documented Hindu institutions were missing; South Africa (7→15) — Pretoria, Mount Edgecombe, and several Durban-area temples; Trinidad and Tobago (2→9) — closing a real gap given the country's large Hindu diaspora; USA ISKCON specifically (3→16 ISKCON-affiliated entries) after the user noted the near-absence of ISKCON coverage despite ISKCON's substantial documented US presence.

**National capitals confirmed to still have zero Hindu temple entries after honest, thorough checking**: Colombo (Sri Lanka) and Islamabad (Pakistan) — both checked specifically per the fuller checklist; no source cleared the sourcing bar for either.

**New countries added**: Guadeloupe, Jamaica, Martinique, Panama, Costa Rica, Belize (Americas); Hungary, Greece, Sweden, Finland (Europe); Hong Kong SAR (treated as a distinct gap from thin mainland China coverage). Austria received its first-ever entry.

**Notable fact-checking catches during this round**: the Oceania agent traced a "Sri Raj Mahamariamman Temple, Suva" lead back to its cited news source via the Wayback Machine and found the source did not actually support the claim — a Wikipedia misattribution, correctly not repeated; it also identified and declined two apparent fake/vaporware entries ("Perth Ram Temple," flagged as unsupported by Wikipedia's own editors; "Hanuman Mandir Adelaide," bearing SEO-spam-content patterns). The Europe agent caught and corrected a factual error in a sibling sub-agent's draft (a Berlin Ganesha temple's community attribution). The SE Asia agent correctly reclassified Bangkok's "Trimurti Shrine" as depicting Sadasiva rather than the Brahma-Vishnu-Shiva triad per its 2017 iconographic reclassification, rather than repeating the popular but outdated name's implication.

**Process incident — repeated across multiple sibling agents this round**: at least four of the seven agents (South Asia, Europe, Americas, Southeast/East Asia + Middle East) reported that their own internally-dispatched "research only, do not write files" sub-agents disregarded that instruction — apparently because forks inherit full conversation context, and when a sub-agent's own attempt to delegate further work hit a "fork not available inside a forked worker" limit, several redid the entire assigned task themselves and wrote files directly, concurrently with their parent agent and each other. This caused real, live file races: duplicate slugs, at least one file deleted mid-churn, and one instance of a sub-agent's delayed completion notification arriving after its parent had already reported and moved on. Every affected agent caught this via unexpected `git status` output, independently re-verified every contested fact via its own fresh WebFetch calls (not trusting the sub-agent's claims), waited for file churn to fully settle, and reconciled duplicates by keeping the better-sourced version. A full repository-wide audit after all seven agents completed (schema validation, `--duplicates`, an `id`-field collision check, a filename collision check, and manual spot-checks of every specific file named in an incident report) confirmed the final state is clean with zero unresolved issues. This is worth remembering for future large parallel-agent dispatches: instruct agents to avoid nesting further sub-delegation for "research only" tasks, or accept that write races are a real risk requiring a final independent verification pass regardless of what agents self-report.

825 temples total, all schema-valid, 108/108 Divya Desam intact, zero `id` or filename collisions confirmed via a full repository re-check; the sole duplicate-detector flag remains the previously investigated Chandi Devi/Mansa Devi (Haridwar) false positive.

## Enrichment Wave 1: all of India (data-quality pass, prep for website)

Shifted from discovery (finding new temples) to enrichment (deepening existing entries) in preparation for an eventual website build. At this point the repository had 507 `pending`-status entries, 681 entries with open `review_flags`, and 298 entries missing coordinates out of 825 total. Eight parallel agents covered all ~500 India entries (Tamil Nadu split into two batches given its size of 145 files; the rest grouped by state). No new temples were added — this was a pure enrichment pass: 273 files modified, zero created, zero deleted.

**Major finding — real data-quality bugs caught and fixed, not just cosmetic polish**:
- **Coordinate errors, several severe**: Divya Desam Mathura's coordinates were ~1,000 km off, sitting in Jharkhand/Bihar instead of Uttar Pradesh. Varadavinayak (Ashtavinayak, Maharashtra) was ~38 km off, pointing between two different towns both named Mahad. Ballaleshwar was ~15 km off. Several other Divya Desam and Ashtavinayak entries had smaller (0.6–12 km) errors, all corrected against verified Wikipedia infobox/OSM values — never estimated. Where a source conflict couldn't be resolved (e.g. a scraped coordinate disagreeing with the dataset's existing value), agents consistently chose to flag the discrepancy or remove the field rather than silently pick one.
- **Wrong administrative/geographic facts**: Divya Desam Thiruvattaru's prose incorrectly located it in "present-day Kerala" — it's actually in Kanyakumari district, Tamil Nadu. Divya Desam entry 023 incorrectly attributed Therazhundur as the birthplace of the Nayanar saint Sekkizhar; only Kambar's birthplace there is actually sourced.
- **A genuine deity-identity mismatch surfaced, not resolved**: Divya Desam Aranmula's AI-generated draft named the deity "Thirukkuralappan" with a Vamana legend, but the real, documented temple at that location (Aranmula Parthasarathy Temple) enshrines Krishna as Parthasarathy with an Arjuna/Mahabharata legend — flagged explicitly rather than silently overwritten either way, since which name the Divya Desam tradition itself uses couldn't be determined.

**Scale of the "AI-generated placeholder" problem, now substantially resolved**: A large fraction of the physical Divya Desam collection's `pending` entries traced back to a bulk-import pipeline (108divyadesam.org) whose content had never been independently verified — carrying a generic review_flag to that effect. This pass re-verified and upgraded roughly 76 of these placeholder entries to `status: verified` with real, dated, cited history (dynasty attributions, inscriptions, festival calendars), including flagship entries like Srirangam, Kanchipuram/Varadaraja, Chidambaram/Govindaraja, Tirumala Tirupati, Ahobilam, and Badrinath — all of which had previously carried nothing but unverified auto-generated prose despite being among the most significant temples in the entire directory.

**Process note, recurring from prior rounds**: multiple agents again reported their own internally-dispatched "research only" sub-agents disregarding that instruction. Every affected agent handled it the same disciplined way this time: distrust the sub-agent's self-report entirely, manually re-diff every file in scope against its original state, verify every claim carries a real citation, and only then report success. One agent explicitly flagged a sub-agent's claim about "sibling agents" as possibly unreliable/hallucinated rather than repeating it as fact. No corruption or fabrication survived to the final state in any case.

825 temples total (unchanged, since this was enrichment not discovery), all schema-valid, 108/108 Divya Desam intact, zero `id` or filename collisions; the sole duplicate-detector flag remains the previously investigated Chandi Devi/Mansa Devi (Haridwar) false positive. Non-India enrichment (Wave 2, ~325 files) is planned as a follow-up.

## Enrichment Wave 2: all countries outside India (data-quality pass, prep for website)

Completed the enrichment effort with 7 parallel agents covering every non-India entry (South Asia, SE/East Asia + Middle East, Europe, USA, North America excluding USA, Africa, Oceania + South America). Like Wave 1, this was pure enrichment — no new temples added.

**Real bugs found and fixed, continuing the pattern from Wave 1**:
- **Coordinate errors, several severe**: New Vrindaban (West Virginia) was ~18 km off. ISKCON Sydney's coordinates pointed to Burwood, ~10 km from its actual North Sydney location. Nova Gokula (Brazil) was ~17 km off. Smaller errors (2-8 km) were found and fixed at Katas Raj (Pakistan), Nallur Kandaswamy (Sri Lanka), Temple in the Sea (Trinidad), Central Vaidik Mandir (Guyana), Shri Shiva Vishnu Temple (Australia), Bhaktivedanta Manor (UK), Radhadesh (Belgium), and BAPS Neasden (UK). One SAHRA-listed coordinate for Mount Edgecombe Ganesha Temple (South Africa) was found to be ~370 km off due to a data error in the source itself and was deliberately rejected rather than propagated.
- **A temple fundamentally mislabeled**: ISKCON Sydney's entry called itself "Bhaktivedanta Swami Mandir" — which is actually the name of a different, well-known ISKCON temple in Kolkata — mistakenly attached to the Sydney entry. The real temple is "Sri Sri Radha Gopinath Mandir." Corrected name, address, coordinates, and history; upgraded to `verified`.
- **A wrong deity roster**: ISKCON Houston's presiding deities were listed generically as "Radha Krishna" when the temple's own official history names them specifically as Sri Sri Radha Nila-Madhava.
- **A likely-fabricated entry identified and removed**: BAPS Swaminarayan Sanstha, "Enfield, County Meath" (Ireland) — tracing its Wikipedia citation back to BAPS's own historical UK & Europe centre directory found no Enfield/Meath entry exists there at all, only a UK "Enfield" (grouped with London-area towns) and a single "Dublin" for all of Ireland. This strongly suggests a Wikipedia conflation between Enfield, County Meath and the identically-named Enfield district of London. Given the strength of this evidence (not merely thin sourcing, but a citation trail that actively contradicts the claim), the entry was removed rather than kept with a flag.
- **A relocated temple correction**: the Radha Krishna Temple, Bury Place, London entry described the 1968 founding site, but the congregation relocated to 10 Soho Street in 1979 and still operates there today (Bury Place was only recently reacquired by ISKCON as a heritage site, not the active temple). Updated to the currently-operating address.
- **A worship-status correction**: Shiva Temple, Oudenaarde (Belgium) actually ceased operating 1 October 2024, replaced by a much smaller facility elsewhere — `worship_status` corrected from `active` to `partially_active` rather than left silently stale.
- **A real branch-affiliation contradiction left honestly unresolved**: Kenya's Eldoret and Kisumu "Swaminarayan Mandir" entries are Wikipedia-sourced as NarNarayan Dev Gadi affiliated, but BAPS's own site and independent directories describe BAPS-affiliated temples at matching addresses/phone numbers in the same towns — unclear if these are the same institution mislabeled or genuinely distinct, left flagged rather than merged or guessed.

**Status upgrades**: roughly 20 entries moved from `pending` to `verified` across the two waves' non-India work, each backed by a genuine second independent source (temple's own official site, a second-language Wikipedia edition, a government/business registry, or a named OSM point-of-interest) — not merely re-asserting the same single source with more confidence.

**Process notes**: the recurring sub-agent-disobedience pattern continued in this wave too, but every affected agent applied the lesson from prior rounds — treat sub-agent self-reports as untrusted, manually re-diff the full scope against the original state, and only then report success. One Africa-region agent went further: it built its own repository-wide scanner (checking for well-formed YAML frontmatter delimiters and non-empty bodies) to catch and fix three self-introduced corruption bugs from its own Edit calls before finishing.

824 temples total (825 minus the one removed Enfield/Meath entry), all schema-valid, 108/108 Divya Desam intact, zero `id` or filename collisions; the sole duplicate-detector flag remains the previously investigated Chandi Devi/Mansa Devi (Haridwar) false positive. This completes both enrichment waves — every entry in the directory has now been through at least one dedicated re-verification pass beyond its original creation.

## Deity worship-category taxonomy (implements the long-dormant Deity + Curated Collection data-model entities)

The original data-model.md (Phase 1, before any content existed) specified a `Deity` entity and a `Curated Collection` concept ("computed grouping... for FR-011") but neither was ever implemented — `Temple.deities` remained the only deity-related field, deliberately free-text and temple-specific (e.g. "Aiyarappar / Panchanadeeswarar (Shiva)"). Implemented this gap: `content/deities/*.md` (29 files, contract `contracts/deity.schema.json`) define canonical worship categories (Rama, Krishna, Narasimha, Varaha, Vamana, Parashurama, Kurma, Matsya, Venkateswara, Jagannath, Vishnu-other, Shiva, Nataraja, Bhairava, Durga, Devi/Shakti-general, Kali, Lakshmi, Saraswati, Ganesha, Murugan, Hanuman, Surya, Brahma, Ayyappa, Dattatreya, Navagraha, Swaminarayan, Sai Baba), each carrying a `match_keywords` list.

`scripts/validate_content.py --deity-report` (with `--export-json PATH` for the full listing) computes the grouping live by word-boundary-matching each temple's free-text `deities` field against every category's keywords, rather than hand-maintaining a list that would immediately go stale — consistent with how the data model always intended Curated Collections to work. A temple can and does legitimately match multiple categories (large multi-shrine complexes, especially BAPS mandirs that enshrine Rama-Sita-Lakshmana-Hanuman, Radha-Krishna, Shiva-Parvati-Ganesha-Kartikeya, Venkateswara-Padmavati, and Jagannath together under one roof, correctly appear in 6+ categories at once).

A fallback tier catches the largest remaining gap: many temples (63 of them Divya Desam entries with untranslated Tamil epithets like "Kalyana Narayanar" or "Thirumoozhikkalathaan") carry no keyword-matching text at all in their `deities` field despite their `traditions` field unambiguously identifying them. For any temple with exactly one of vaishnava/shaiva/shakta in `traditions`, the fallback buckets it into that tradition's general category (vishnu-other/shiva/devi-shakti respectively). This cut the uncategorized count from 125 to 37 (4.5% of 824) in one pass.

**Verification of the matcher's accuracy**: several apparent false positives were spot-checked against the temples' actual `deities` fields and every one confirmed correct — e.g. Durgiana Temple, Amritsar genuinely lists both "Durga" and "Lakshmi-Narayan (Lakshmi and Vishnu)" (correctly appears in both the Durga and Vishnu categories); Kaila Devi Temple's own deity field parenthetically identifies her as "(Mahalakshmi/Mahayogini)" (correctly appears under Lakshmi); the Mariamman Temple, Ho Chi Minh City genuinely enshrines Mariamman, Shiva, Vishnu, Brahma, and Kali together (correctly appears in five categories). No genuine false positive was found in spot-checking.

**Final category counts** (824 temples, keyword matches only or via fallback, a temple may count in several): Shiva 262, Vishnu (other forms) 219, Devi/Shakti (general) 167, Krishna 122, Ganesha 72, Durga 70, Murugan 52, Lakshmi 43, Hanuman 42, Rama 41, Swaminarayan 31, Venkateswara 28, Kali 21, Jagannath 15, Narasimha 15, Saraswati 14, Navagraha 12, Surya 12, Brahma 10, Ayyappa 8, Nataraja 7, Bhairava 6, Parashurama 4, Sai Baba 4, Dattatreya 3, Vamana 2, Kurma 1, Varaha 1, Matsya 0. The remaining 37 genuinely-uncategorized entries are legitimate edge cases (deities explicitly "unspecified in available sources," non-classical figures like Vishwakarma/Valmiki/Ramdev Pir/Ramakrishna Paramahamsa, Balinese-specific names like Sang Hyang Widhi Wasa, and Arya Samaj's aniconic worship) rather than taxonomy gaps worth chasing further.

824 temples total, unchanged (this added a schema, a script feature, and 29 new lightweight category files — no temple entries were modified). All schema-valid, 108/108 Divya Desam intact.

## Beyond-Earth and deity-category enrichment via the sibling vidya-karana-kg corpus

Discovered a genuinely useful cross-project resource: `/Users/sree/Projects/vidya-karana-kg`, a separate, unrelated project of the user's (a NetworkX-based knowledge graph over a 214,325-chunk corpus of Bhagavad Gita/Srimad Bhagavatam/Mahabharata/Ramayana text, built for an AI value-education pipeline). Its seeded ontology (293 Character nodes, 49 Concept nodes) turned out to have no dedicated Loka/cosmology entities — it's scoped to virtues and narrative figures, not cosmology — but its underlying ChromaDB text corpus could still be searched directly for specific scripture passages, giving precise verse-level citations beyond what a generic Wikipedia fetch provides.

Used this to strengthen several `content/beyond-earth/` entries: added a Wikipedia "Loka" article cross-check to `bhuvarloka.md` (directly resolving its open flag asking for independent corroboration — confirmed the seven-upper-loka order and Bhuvarloka's position); added a Wikipedia "Patala" cross-check to `the-seven-patalas.md` (confirmed all seven ruler-attributions — Bala/Atala, Hara-Bhava/Vitala, Bali/Sutala, Maya/Talatala, Naga clans/Mahatala, Danavas/Rasatala, Vasuki/Patala — match exactly); and added a specific verse citation (Srimad Bhagavatam 8.5.6, Sarartha-darsini commentary) plus a Gaudiya-commentarial detail (Rama's abode also placed within Vaikuntha per a specific Ramayana commentary tradition) to `vaikuntha.md`, independently re-verified against vedabase.io before use.

Also replaced the generic, non-verified placeholder source note on two `content/deities/` category files with real corpus-grounded citations: `narasimha.md` (Srimad Bhagavatam Canto 7's Prahlada/Hiranyakashipu narrative) and `rama.md` (Valmiki Ramayana's own account of the avatara descent). The other 27 deity category files still carry the original general-knowledge placeholder note — replacing those with equally specific citations remains a good candidate for a future pass using the same method.

824 temples total, unchanged. All schema-valid, 108/108 Divya Desam intact.

## Completed the deity-category citation pass: 17 of 29 categories now have verified scripture sources

Extended the previous pass across the remaining 27 deity category files, systematically corpus-searching each and independently re-verifying every candidate citation against vedabase.io before use (never trusting a corpus excerpt at face value). Upgraded 15 more categories with real citations: varaha (SB 2.7.1, boar lifts the earth), vamana (SB 6.8.13, the Trivikrama protective verse), kurma (SB Canto 12, the tortoise scratched by Mount Mandara), matsya (SB 1.3.15, saving Vaivasvata Manu), parashurama (SB 2.7.22 and Canto 9, the twenty-one-fold slaying of the kshatriyas), krishna (the Nanda/Vrindavan upbringing narrative), vishnu-other (SB 3.28.13, the classic four-armed dhyana-verse), jagannath (Sri Caitanya-caritamrta's firsthand Puri/Rath-Yatra material), hanuman (Valmiki Ramayana, Sundara Kanda Sarga 1, the leap to Lanka), surya (SB 5.21.16, Aruna driving the sun-chariot), brahma (SB 9.1.9, birth from the lotus at Vishnu's navel), dattatreya (SB 2.7.4, the Lord's promise to sage Atri), murugan (Valmiki Ramayana Bala Kanda Sarga 37, Skanda as army commander), saraswati (SB 8.8.16, her gift at the post-Manthan celestial wedding), and lakshmi (a classical Manasara Shilpa Shastra iconographic description).

**Honestly left unchanged (12 of 29)**: shiva, venkateswara, durga, devi-shakti, kali, ganesha, nataraja, bhairava, ayyappa, navagraha, swaminarayan, sai-baba. Every one was actually searched (not skipped by assumption) and confirmed to have no usable specific material in this corpus — consistent with the corpus's actual scope (predominantly Gaudiya Vaishnava/Bhaktivedanta Book Trust texts plus core itihasa: Bhagavad Gita, Srimad Bhagavatam, Mahabharata, Valmiki Ramayana). This systematically underrepresents Shakta/Devi material (Durga, Kali, Devi-Shakti — the one partial hit for Kali lacked a precise verse number and conflated Kali with Durga in a way this repo's taxonomy deliberately keeps separate, so it was not used), Ganapatya material (Ganesha), Shaiva Agama/Puranic material (Nataraja, Bhairava), South Indian regional traditions (Ayyappa), technical astrological material (Navagraha), and figures from after the corpus's classical period (Swaminarayan, 18th century; Sai Baba, 19th-20th century). This is a genuine corpus-scope limitation, not a research shortcut — each of the 12 got at least one, and several got two, differently-worded search attempts before being left as-is.

824 temples total, unchanged. All schema-valid, 108/108 Divya Desam intact.

## Place-based gap audit via the vidya-karana corpus: 20 temples, 3 new countries

Extended the vidya-karana cross-reference from deity/cosmology concepts to actual place names. Two distinct real-location datasets were found and used: (1) Srila Prabhupada's own travel-letter locations (an 88-city metadata field on "letter" chunks, tagging where each of his 1965-1977 letters founding ISKCON worldwide was written from) and (2) itihasa/Purana place names confirmed present in the scripture corpus itself (Hastinapura, Sandipani's Avantipur ashram, Kaundinya/Vidarbha, etc.), each cross-checked against this directory's existing coverage.

**The single most significant finding**: Mumbai (Bombay) — the single highest-frequency location in Prabhupada's own letters after Los Angeles — had zero ISKCON coverage in this directory despite ISKCON Juhu (Sri Sri Radha Rasabihari Mandir, "Hare Krishna Land") being one of the movement's largest and most historically significant temples, the site of Prabhupada's own land-dispute battles in the 1970s. Added, sourced from corroborating Wikipedia biographies (Prabhupada's own article; Giriraja Swami's, ISKCON Bombay's founding president) since no dedicated Wikipedia article for the temple itself exists.

**Other confirmed India gaps filled (7 total, all ISKCON)**: Kolkata (3C Albert Road — the address Prabhupada's own 50th-departure-anniversary monument is split-installed at), Hyderabad (Hare Krishna Golden Temple, Banjara Hills, inaugurated 2018), Chandigarh, Bhubaneswar, Kanpur, Amritsar. Indore, Nellore, and Surat were checked and honestly confirmed to have no documented ISKCON presence.

**International gaps filled (8)**: Honolulu (where Prabhupada personally resided 1974-76), Seattle, Denver, Miami, Buffalo (correctly marked `worship_status: heritage` — active 1969 through at least 1975, no current successor found), Hamburg, Geneva, and Manila (a new country for this directory — a non-ISKCON Sindhi-community "Hindu Temple, Inc.," with an unverified ISKCON-adjacency claim explicitly flagged rather than asserted). Frankfurt, Johannesburg, and Tehran were checked and honestly confirmed to have no documented ISKCON temple (Frankfurt has 5 real Hindu temples, none ISKCON; Tehran's only historical Hindu temples are elsewhere in Iran).

**Central Asia and Mongolia (2 new countries, 4 honest negatives)**: Kazakhstan (ISKCON Almaty, with a documented 2006-2007 land-dispute/demolition controversy described factually) and Uzbekistan (ISKCON Tashkent) were added. Kyrgyzstan, Tajikistan, Turkmenistan (confirmed home-worship-only by a 2004 government decree — no temple building permitted), and Mongolia (a real "Krishna Mandir" institution found via its own devotional website, but no source anywhere stated its city, so it was correctly left unadded rather than assume Ulaanbaatar) were honestly left uncovered.

**Itihasa-place gaps filled (3)**: Pandeshwar Mahadev Temple, Hastinapur (the Mahabharata's Kuru capital, carefully kept distinct from Hastinapur's much larger Jain pilgrimage complex); Sandipani Ashram, Ujjain (Krishna and Balarama's traditional gurukul, independently corroborated across three separate Wikipedia articles beyond the Sandipani biography page); and the Rukmini Temple, Kaundinyapur (ancient Vidarbha's capital and Rukmini's birthplace, where a genuine archaeological record — 14th-15th century structures, Copper Age finds — was kept honestly separate from the legendary Puranic identification).

A genuinely useful methodological note: this place-based approach surfaced real, significant gaps (especially Mumbai) that none of the prior category-based, circuit-based, or geography-based audit rounds caught, because those rounds were organized around deities, canonical lists, or broad geography rather than "where did this specific historical religious movement's founder actually go."

844 temples total, all schema-valid, 108/108 Divya Desam intact.
