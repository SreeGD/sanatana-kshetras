---
id: iskcon-dar-es-salaam
name: "ISKCON Dar es Salaam Centre"
deities:
  - "Radha Krishna"
...
best_time_to_visit: "Janmashtami (Aug/Sep) draws the largest crowds; otherwise year-round given Dar es Salaam's tropical coastal climate."
how_to_reach: "On Mosque Street in Dar es Salaam's city center."
associated_saints:
  - "A. C. Bhaktivedanta Swami Prabhupada"
sources:
  - {type: historical_record, note: "Cross-checked against Wikipedia's 'Hinduism in Tanzania' article, which lists the 'Iskcon Dar es Salaam Centre, Mosque street, Dar es Salaam' in its inventory of Hindu temples in the country and separately notes that 'followers of Brahma Kumari, Satya Sai Baba and Hare Krishna also have a presence amongst the Hindus in Tanzania,' alongside a second Iskcon center listed in Arusha."}
...
Tanzania's Hare Krishna community sits alongside a wider Hindu religious landscape shaped mainly by Gujarati migration, in which movements such as the Swaminarayan sampradaya, Brahma Kumaris, and followers of Sathya Sai Baba also maintain an organized presence. ISKCON's arrival in East Africa is best documented in neighboring Kenya, where Hare Krishna devotees were active from 1969; while no equivalently detailed founding account for the Dar es Salaam center was located during this research pass, its presence is confirmed as part of Tanzania's broader, well-documented network of Hindu religious institutions.
