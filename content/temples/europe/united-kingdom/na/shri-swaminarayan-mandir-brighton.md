---
id: shri-swaminarayan-mandir-brighton
name: "Shri Swaminarayan Mandir, Brighton"
deities:
  - "Swaminarayan"
...
The temple's murti pratishtha (deity installation) ceremony was performed by Acharya Maharajshree Tejendraprasad Pande and drew a notably civic guest list for a provincial UK temple opening: the local Member of Parliament, the Mayor of Brighton, and the Indian High Commissioner all attended, reflecting the occasion's significance both to the local Gujarati Hindu community and to Brighton's wider civic life. Beyond these founding details, the Wikipedia source available for this entry is only a brief stub, leaving the temple's later history, exact address, and architectural character undocumented in the sources consulted here.
