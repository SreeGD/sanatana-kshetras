---
id: thiruppiridhi-divyadesam-098
name: "Vasudeva Perumal Temple"
alt_names:
  - {language: tamil, script: Tamil, value: "அருள்மிகு வாசுதேவன் திருக்கோயில்"}
  - {language: tamil, script: Tamil, value: "திருப்பிரிதி"}
deities:
  - "Vasudeva Perumal"
...
region: "Uttarakhand"
city: "Thiruppiridhi"
coordinates: {lat: 30.57, lng: 79.57}
...
how_to_reach: "Located at Thiruppiridhi, Uttarakhand; consult local transport options for the nearest railway station, bus stand, or airport."
associated_saints:
  - "Thirumangai Alwar"
sources:
...
status: pending
review_flags:
  - "History, festival, and access narrative below is AI-generated (recorded as auto-review, not independently verified, in the 108divyadesam.org project's own pipeline) and has not yet been checked against scholarly or primary sources; treat as an informed draft, not confirmed fact, until reviewed. A fresh verification attempt in September 2026 found no dedicated Wikipedia article or other independent source for this specific Divya Desam under either 'Thiruppiridhi' or 'Thiruppireedhi', so the flag remains unresolved; the site's precise identification and even its physical existence as a distinct, locatable temple (as opposed to a devotional place-name in the Naalayira Divya Prabandham) could not be independently confirmed."
---
