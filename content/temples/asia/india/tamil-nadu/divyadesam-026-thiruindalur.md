---
id: thiruindalur-divyadesam-026
name: "Parimala Ranganathar Temple"
alt_names:
  - {language: tamil, script: Tamil, value: "அருள்மிகு பரிமளரங்கநாதர் திருக்கோயில்"}
  - {language: tamil, script: Tamil, value: "திருஇந்தளூர்"}
deities:
...
region: "Tamil Nadu"
city: "Thiruindalur"
coordinates: {lat: 11.1096188, lng: 79.6466946}
...
how_to_reach: "Located at Thiruindalur, Tamil Nadu; consult local transport options for the nearest railway station, bus stand, or airport."
associated_saints:
  - "Thirumangai Alwar"
sources:
  ...
  - {type: historical_record, note: "Re-verification pass (2026): a Wikipedia article titled 'Indalur' was checked and found to describe a different, unrelated village of the same name in Thanjavur taluk, Thanjavur district -- not this Thiruindalur near Mayiladuthurai -- and was NOT used as a source here. No dedicated article for this temple was found. Wikipedia's 'Divya Desam' list article gives the consort name as Parimala Ranganayaki (paired with Sri Parimala Ranganatha Perumal) and confirms the Mayiladuthurai-district location."}
documented_vs_legend: mixed
status: pending
review_flags:
  - "Construction period, dynasty, inscriptions, architecture, and specific festival dates remain unconfirmed for this temple. Its Indra-worship legend and the Alwar-pleading-for-darshan episode in the prose below were neither confirmed nor contradicted by any source checked this pass."
---
