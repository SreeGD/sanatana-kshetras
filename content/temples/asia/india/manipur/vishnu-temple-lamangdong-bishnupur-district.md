---
id: vishnu-temple-lamangdong-bishnupur-district
name: "Vishnu Temple, Lamangdong"
deities:
  - "Vishnu"
...
how_to_reach: "Lamangdong lies near Bishnupur town, a short distance south of Imphal along NH2 (the Imphal-Tiddim road); served by Imphal (Bir Tikendrajit International) Airport, with road connections onward to Bishnupur district."
sources:
  - {type: historical_record, note: "Cross-checked against Wikipedia's Bishnupur, Manipur article: confirms that Bishnupur district takes its name from this Vishnu temple at Lamangdong, that its construction is credited to the Meitei king Kyamba following an alliance/treaty around 1470 CE with the Shan ruler of Pong (during which a Vishnu image was presented to Kyamba, prompting him to build a brick temple and install the idol, establishing Vishnu worship in the region), and that the site is today maintained as a protected monument under the Ministry of Human Resource Development's Archaeology wing (i.e. under Archaeological Survey of India-linked protection)."}
...
The temple today is protected as a heritage monument, though how much of its historic fabric survives and how actively it continues to be used for regular worship, as opposed to being primarily a custodial archaeological site, is not clearly detailed in the source consulted for this entry — a gap visitors and future contributors should help clarify. Even so, as the namesake shrine of an entire Manipuri district, Lamangdong's Vishnu temple holds an outsized place in the early religious history of the Manipur valley.
